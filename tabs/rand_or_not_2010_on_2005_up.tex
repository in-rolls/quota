...
\hline \\[-1.8ex] 
 2005 & $-$0.02$^{***}$ & $-$0.02$^{***}$ & $-$0.02$^{*}$ \\ 
  & (0.01) & (0.01) & (0.01) \\ 
  Constant & 0.34 & 0.32 & 0.34 \\ 
  & (0.004) & (0.03) & (0.005) \\ 
 \hline \\[-1.8ex] 
Observations & 24,017 & 24,017 & 16,389 \\ 
Adjusted R$^{2}$ & 0.001 & 0.001 & 0.0002 \\ 
\hline 
\hline \\[-1.8ex] 
...
\item[] Statistical significance symbols for the constant terms are suppressed.
                   ...
                   Within district regressions yield 12 significant coefficients at the 5% level.
\end{tablenotes}
\end{threeparttable}
\end{table}
